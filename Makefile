...
part2_test: test_DocGen.o
	g++ -o part2_test test_DocGen.o

test_DocGen.o: DocumentGenerator.hpp test_DocGen.cpp

part1_test: test_TST.o
	g++ -o part1_test test_TST.o

test_TST.o: test_TST.cpp Autocomplete.hpp

clean:
	$(RM) main main2 *.o *.gch part2_test
